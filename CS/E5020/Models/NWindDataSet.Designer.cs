...
namespace E5020.Models {
    ...
    public partial class NWindDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProductsRow AddProductsRow(string ProductName, decimal UnitPrice, short UnitsInStock, short UnitsOnOrder, bool Discontinued, string CategoryName) {
        ...
        public partial class OrdersDataTable : global::System.Data.TypedTableBase<OrdersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public OrdersRow AddOrdersRow(System.DateTime OrderDate, string ShipAddress, string ShipCity, string ShipRegion, string ShipPostalCode, string ShipCountry, string CompanyName, string ContactName, string Title, string LastName, string FirstName) {
...
namespace E5020.Models.NWindDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        Products.ProductID, Products.ProductName, Products.UnitPrice, Products.UnitsInStock, Products.UnitsOnOrder, Products.Discontinued, 
...
FROM            (Products INNER JOIN
    ...
    public partial class OrdersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        Orders.OrderID, Orders.OrderDate, Orders.ShipAddress, Orders.ShipCity, Orders.ShipRegion, Orders.ShipPostalCode, Orders.ShipCountry, 
                         Customers.CompanyName, Customers.ContactName, Employees.Title, Employees.LastName, Employees.FirstName
