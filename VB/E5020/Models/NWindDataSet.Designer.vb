...
Partial Public Class NWindDataSet
    ...
    Partial Public Class ProductsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddProductsRow(ByVal ProductName As String, ByVal UnitPrice As Decimal, ByVal UnitsInStock As Short, ByVal UnitsOnOrder As Short, ByVal Discontinued As Boolean, ByVal CategoryName As String) As ProductsRow
            Dim rowProductsRow As ProductsRow = CType(Me.NewRow,ProductsRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, ProductName, UnitPrice, UnitsInStock, UnitsOnOrder, Discontinued, CategoryName}
    ...
    Partial Public Class OrdersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddOrdersRow(ByVal OrderDate As Date, ByVal ShipAddress As String, ByVal ShipCity As String, ByVal ShipRegion As String, ByVal ShipPostalCode As String, ByVal ShipCountry As String, ByVal CompanyName As String, ByVal ContactName As String, ByVal Title As String, ByVal LastName As String, ByVal FirstName As String) As OrdersRow
            Dim rowOrdersRow As OrdersRow = CType(Me.NewRow,OrdersRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, OrderDate, ShipAddress, ShipCity, ShipRegion, ShipPostalCode, ShipCountry, CompanyName, ContactName, Title, LastName, FirstName}
    ...
    Partial Public Class OrdersRow
        ...
        Public Function IsContactNameNull() As Boolean
            Return Me.IsNull(Me.tableOrders.ContactNameColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetContactNameNull()
            Me(Me.tableOrders.ContactNameColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace NWindDataSetTableAdapters
    ...
    Partial Public Class ProductsTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT        Products.ProductID, Products.ProductName, Products.UnitPrice, Produ"& _ 
                ...
                "           Categories.CategoryName"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            (Products INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"      "& _ 
    ...
    Partial Public Class OrdersTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        Orders.OrderID, Orders.OrderDate, Orders.ShipAddress, Orders.ShipCi"& _ 
                "ty, Orders.ShipRegion, Orders.ShipPostalCode, Orders.ShipCountry, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"            "& _ 
                "             Customers.CompanyName, Customers.ContactName, Employees.Title, Empl"& _ 
                "oyees.LastName, Employees.FirstName"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            ((Orders INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"      "& _ 
                "                   Customers ON Orders.CustomerID = Customers.CustomerID) INNER "& _ 
                "JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                         Employees ON Orders.EmployeeID = Employees.Employ"& _ 
                "eeID)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
        End Sub
